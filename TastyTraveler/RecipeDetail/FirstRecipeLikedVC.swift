//
//  FirstRecipeLikedVC.swift
//  TastyTraveler
//
//  Created by Tyler Clonts on 1/19/19.
...
class FirstRecipeLikedVC: UIViewController {
    ...
    let descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "You just earned 1 point for liking that recipe!"
